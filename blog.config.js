...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'JTNL', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一個努力的普通人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jtnl.cc', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'JTNL Travel', // 网站关键词 英文逗号隔开
